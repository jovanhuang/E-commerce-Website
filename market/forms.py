...
class RegisterForm(FlaskForm):
    ...
    # FlaskForm will auto read the function. If it has 'validate' infront, it will look at the word after 'validate_' and link the validator function to that variable 'username' in this case.
